 ...
 */
function additionalsearchparams_civicrm_xmlMenu(&$files) {
  _additionalsearchparams_civix_civicrm_xmlMenu($files);
}
 ...
 */
function additionalsearchparams_civicrm_managed(&$entities) {
  _additionalsearchparams_civix_civicrm_managed($entities);
}
 ...
 */
function additionalsearchparams_civicrm_caseTypes(&$caseTypes) {
  _additionalsearchparams_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function additionalsearchparams_civicrm_angularModules(&$angularModules) {
  _additionalsearchparams_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function additionalsearchparams_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
  _additionalsearchparams_civix_civicrm_alterSettingsFolders($metaDataFolders);
}
